...
function cdek_widget_enqueue_script()
{
    if (is_checkout()) {
        ...
        wp_enqueue_script('cdek-map', plugin_dir_url(__FILE__) . 'assets/js/map-v1.js', array('jquery'), '1.7.0', true);
        addYandexMap();
    }
}
...
{
    wp_enqueue_script('cdek-admin-delivery', plugin_dir_url(__FILE__) . 'assets/js/delivery-v1.js', array('jquery'), '1.7.0', true);

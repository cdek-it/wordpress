            ...
            try {
                ...
                if (!empty($track)) {
                    if ($attempt > 0) {
                        Note::send(
                            ...
                            sprintf(
                                ...
                                esc_html__('Order created automatically after %1$s attempts', 'cdekdelivery'),
                                $attempt,
                            ),
                        );
                    }
                    ...
                    Note::send(
                        ...
                        sprintf(
                            ...
                            esc_html__('Tracking number: %1$s', 'cdekdelivery'),
                            $track,
                        ),
                        true,
                    );
                ...
                Note::send(
                    ...
                    sprintf(
                        ...
                        esc_html__('Cdek shipping error: %1$s', 'cdekdelivery'),
                        $e->getMessage(),
                    ),
                );

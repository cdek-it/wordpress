    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'tariff_plug' => [
                ...
                'type' => 'text',
                'description' => "Этот тариф будет появляться когда у пользователя еще не добавлены параметры для расчета доставки."
            ],
//            'service_list' => [
...
//            ],
    ...
    public function calculate_shipping($package = [])
    {
        if (is_cart() || is_checkout()) {
            ...
            $adminSetting = Helper::getSettingDataPlugin();
            $tariffPlug = 'Доставка CDEK';
            if (array_key_exists('tariff_plug', $adminSetting) && $adminSetting['tariff_plug'] !== '') {
                $tariffPlug = $adminSetting['tariff_plug'];
            }
            $this->add_rate([

    ...
    final public function init_form_fields(): void
    {
        ...
        $this->form_fields = [
            ...
            'automate_orders'                    => [
                ...
                'type'        => 'checkbox',
                'description' => __('If you have information about the dimensions and correctly filled in shipping addresses, the CDEK invoice will be created automatically',
                                    'cdekdelivery'),
            ],
            'tariff_list'                        => [
                ...
                'description' => __("To select multiple tariffs, hold down the \"CTRL\" key and select tariffs with the left mouse button.",
                                    'cdekdelivery'),
                'css'         => 'height: 400px;',
            ],
            'tariff_name'                        => [
            ...
            'extra_day'                          => [
                ...
                'type'              => 'number',
                'desc_tip'          => true,
                'description'       => __('Number of days will be added to the estimated delivery time',
                                          'cdekdelivery'),
                'default'           => 0,
                'custom_attributes' => [
                    'min'  => 0,
            ...
            'map_auto_close'                     => [
                ...
                'type'        => 'checkbox',
                'desc_tip'    => true,
                'description' => __('If this setting is enabled, then after selecting a pick-up point on the checkout page, the card will automatically close.',
                                    'cdekdelivery'),
                'default'     => 'no',
            ],
            'map'                                => [
            ...
            'product_weight_default'             => [
                'title'             => __('Default weight of one item in', 'cdekdelivery').
                                       ...
                                       ')',
                'desc_tip'          => true,
                'description'       => sprintf(__('All goods must have their weight indicated, if there are goods without %s a specified weight, then for such goods the value from this field will be substituted. %s This will affect the accuracy of the delivery calculation. The default value is 1 weight unit specified in the settings.',
                                                  'cdekdelivery'), "<br>", "<br>"),
                'type'              => 'number',
                'default'           => 1,
                'custom_attributes' => [
            ...
            'product_package_default_toggle'     => [
                ...
                'description' => __('Force the use of product dimensions (length, width and height) by default for all products',
                                    'cdekdelivery'),
                'type'        => 'checkbox',
                'desc_tip'    => true,
                'default'     => 'no',

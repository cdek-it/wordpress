...
//        }
        $this->form_fields = array(
            ...
            'tariff_name' => array(
                'title' => __('Название тарифа', 'official_cdek'),
                'type' => 'text',
                'description' => 'Изменить название тарифа. В списке тарифов в скобках указан код тарифа. Для изменения названия тарифа
                в поле добавляется запись в формате код-название, для множетсвенного изменения, тарифы отделяются точкой с запятой, например
                запись которая изменит название 136 и 137 тарифа: 136-Доставка до пвз;137-Доставка курьером'
            ),

...
<details>
    ...
    You can find the instruction on the [Yandex map](./yandex.mdx) page.
...
<details>
    ...
    Please check that you have followed the [key setup instruction](./yandex.mdx) precisely and waited for the specified
    time.
